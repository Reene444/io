...
import { LinkedinText } from 'some-3d-models';
const LinkedinTextModel = ({ position = [0, 0, 0], rotation = [0, 0, 0], scale = 1, color = '0xffa500', onClickUrl = 'https://github.com/Reene444' }) => {
  const { scene } = useGLTF(LinkedinText);
...
useGLTF.preload(LinkedinText);

export default LinkedinTextModel;
