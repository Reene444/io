...
import LinkedinTextModel from './components/LinkedinTextModel'
import TwitterTextModel from './components/TwitterTextModel'
      ...
      <Canvas shadows onPointerDown={(e) => e.target.requestPointerLock()}>
        <Suspense
          ...
          <Physics timeStep="vary">
            ...
            <GithubTextModel rotation={[0, (-Math.PI * 15) / 18, 0]} scale={1} position={[1.5, 0, 5]} />
            <LinkedinTextModel rotation={[0, (-Math.PI * 15) / 18, 0]} scale={0.3} position={[-2, 0, 5.5]} onClickUrl='https://www.linkedin.com/in/lchen198/' />
            <TwitterTextModel rotation={[0, (-Math.PI * 15) / 18, 0]} scale={0.4} position={[0, -1, 5]} onClickUrl='https://x.com/Reene4444' />
